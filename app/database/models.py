...
class StrategySettings(Base):
    ...
    use_volume_filter: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    ...
    min_signal_strength: Mapped[int] = mapped_column(default=50, nullable=False)
