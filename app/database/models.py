...
class StrategySettings(Base):
    ...
    atr_sl_mult: Mapped[float] = mapped_column(Float, default=1.8, nullable=False)
    atr_tp_mult: Mapped[float] = mapped_column(Float, default=5.0, nullable=False)
    ...
    min_adx: Mapped[float] = mapped_column(Float, default=18.0, nullable=False)
    ...
    min_signal_strength: Mapped[int] = mapped_column(default=62, nullable=False)
    min_hours_between_signals: Mapped[float] = mapped_column(Float, default=24.0, nullable=False)
    max_signals_per_day: Mapped[int] = mapped_column(default=1, nullable=False)
    leverage: Mapped[int] = mapped_column(default=20, nullable=False)
    partial_tp_enabled: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
